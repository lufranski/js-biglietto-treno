...
document.getElementById("container").innerHTML = ` Gentile cliente, hai selezionato un viaggio di ${tripDuration}. La tariffa per la fascia d'et&aacute; da te selezionata &eacute; ${reducedTicket}. Grazie per averci scelto e buon viaggio! `